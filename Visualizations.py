...
# ## 1. Histogram
# This histogram shows the age and marital status, it shows that people from the age 20 till almost 55 are single , and from the age 26 and above are married, and some people from 30 to alomst 70 get divorced. 
